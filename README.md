...
In this project, you will use a relational database to create the initial data structure for a clinic. You will create a table to store patients information, medical histories and invoices.
...
Feel free to check the [issues page](https://github.com/Leeoasis/diagram-based-database/issues).
